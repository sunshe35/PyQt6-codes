...
from PyQt6.QtCore import (QByteArray, QFile, QFileInfo, QPoint, QSettings,
...
class MainWindow(QMainWindow):
    ...
    def create_actions(self):
        ...
        self._new_act = QAction(icon, "&New", self,
                shortcut=QKeySequence.StandardKey.New, statusTip="Create a new file",
                triggered=self.new_file)

        icon = QIcon.fromTheme("document-open", QIcon('images/open.png'))
        self._open_act = QAction(icon, "&Open...", self,
                shortcut=QKeySequence.StandardKey.Open, statusTip="Open an existing file",
                triggered=self.open)
        ...
        self._exit_act = QAction("E&xit", self, shortcut=QKeySequence.StandardKey.Quit,
