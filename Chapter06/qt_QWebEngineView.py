...
class WebEngineView(QWebEngineView):
    ...
    def createWindow(self, QWebEnginePage_WebWindowType):
        ...
        newWin.resize(int(availableGeometry.width() * 2 / 3), int(availableGeometry.height() * 2 / 3))
        newWin.show()
...
class MainWindow(QMainWindow):
    ...
    def inintToolBar(self, homeUrl):
        ...
        self.homeButton.clicked.connect(lambda: self.webEngineView.load(QUrl(homeUrl)))
    ...
    def back(self):
        self.webEngineView.triggerPageAction(QWebEnginePage.WebAction.Back)
