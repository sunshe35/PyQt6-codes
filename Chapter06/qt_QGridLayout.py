import sys
from PyQt6.QtWidgets import QApplication, QWidget, QGridLayout, QPushButton, QLayoutItem, QSpacerItem, QSizePolicy, \
...
class GridLayoutDemo(QWidget):
    def __init__(self, parent=None):
        ...
        # 开始表演
        spacer = QSpacerItem(100, 70, QSizePolicy.Policy.Maximum)
        ...
        spacer2 = QSpacerItem(100, 100, QSizePolicy.Policy.Maximum)
