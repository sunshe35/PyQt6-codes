...
class Ui_MatrixWin(object):
    def setupUi(self, MatrixWin):
        ...
        self.okBtn.clicked.connect(MatrixWin.uiAccept) # type: ignore
        self.cancelBtn.clicked.connect(MatrixWin.uiReject) # type: ignore
        self.clearBtn.clicked.connect(MatrixWin.uiClear) # type: ignore
        self.iceHorizontalSlider.valueChanged['int'].connect(MatrixWin.uiIceSliderValueChanged) # type: ignore
        self.tequilaScrollBar.valueChanged['int'].connect(MatrixWin.uiScrollBarValueChanged) # type: ignore
