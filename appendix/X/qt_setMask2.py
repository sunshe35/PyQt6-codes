...
from PyQt6.QtGui import QPixmap, QPainter, QCursor,QMouseEvent,QPaintEvent
...
class ShapeWidget(QWidget):
    ...
    def updatePix(self):
        ...
        self.pix = QPixmap(self.mypic[self.i], "0", Qt.ImageConversionFlag.AvoidDither | Qt.ImageConversionFlag.ThresholdDither | Qt.ImageConversionFlag.ThresholdAlphaDither)
