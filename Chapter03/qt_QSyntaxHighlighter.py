import sys
from PyQt6.QtWidgets import QMainWindow,QApplication,QTextEdit,QPlainTextEdit,QMenu,QFileDialog,QMessageBox
from PyQt6.QtCore import QRegularExpression
from PyQt6.QtGui import QColor, QTextCharFormat, QFont, QSyntaxHighlighter,QKeySequence
...
class MainWindow(QMainWindow):
    ...
    def setupFileMenu(self):
        ...
        fileMenu.addAction("&New", self.newFile, QKeySequence.StandardKey.New)
        fileMenu.addAction("&Open...",self.openFile, QKeySequence.StandardKey.Open)
        fileMenu.addAction("E&xit", QApplication.quit, QKeySequence.StandardKey.Quit)
