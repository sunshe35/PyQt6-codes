...
class FontComboBoxDemo(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        font2.setWritingSystem(QFontDatabase.WritingSystem.SimplifiedChinese)
    ...
    def setBold(self, button):
        if button.isChecked():
            self.text_show.setFontWeight(QFont.Weight.Bold)
        else:
            self.text_show.setFontWeight(QFont.Weight.Normal)
