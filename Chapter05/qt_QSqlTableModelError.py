...
class SqlTableModelDemo(QWidget):
    ...
    def setTableView(self):
        ...
        self.tableModel.setHeaderData(0, Qt.Orientation.Horizontal, "编号")
        self.tableModel.setHeaderData(1, Qt.Orientation.Horizontal, "姓名")
        self.tableModel.setHeaderData(2, Qt.Orientation.Horizontal, "科目")
        self.tableModel.setHeaderData(3, Qt.Orientation.Horizontal, "性别")
        self.tableModel.setHeaderData(4, Qt.Orientation.Horizontal, "年纪")
        self.tableModel.setHeaderData(5, Qt.Orientation.Horizontal, "成绩")
        self.tableModel.setHeaderData(6, Qt.Orientation.Horizontal, "说明")
