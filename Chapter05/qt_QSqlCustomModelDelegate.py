...
class CustomSqlModel(QSqlQueryModel):
    ...
    def data(self, index: QModelIndex, role=Qt.ItemDataRole.DisplayRole):
        ...
        # 调整数据显示内容
        if value is not None and role == Qt.ItemDataRole.DisplayRole:
            if index.column() == ID:
                return '#' + str(value)
        ...
        if role == Qt.ItemDataRole.ForegroundRole:
            if index.column() == NAME:
                ...
                score = QSqlQueryModel.data(self, index, Qt.ItemDataRole.DisplayRole)
                if score < 80:
    ...
    def setData(self, index: QModelIndex, value, role=Qt.ItemDataRole.EditRole):
        ...
        # 数值发生变化才可以编辑
        valueOld = self.data(index, Qt.ItemDataRole.DisplayRole)
        if valueOld == value:
            return False
...
class SqlQueryModelDemo(QWidget):
    ...
    def setTableView(self):
        ...
        # 设置表头
        self.editModel.setHeaderData(ID, Qt.Orientation.Horizontal, "编号")
        self.editModel.setHeaderData(NAME, Qt.Orientation.Horizontal, "姓名")
        self.editModel.setHeaderData(SUBJECT, Qt.Orientation.Horizontal, "科目")
        self.editModel.setHeaderData(SEX, Qt.Orientation.Horizontal, "性别")
        self.editModel.setHeaderData(AGE, Qt.Orientation.Horizontal, "年纪")
        self.editModel.setHeaderData(SCORE, Qt.Orientation.Horizontal, "成绩")
        self.editModel.setHeaderData(DESCRIBE, Qt.Orientation.Horizontal, "说明")
