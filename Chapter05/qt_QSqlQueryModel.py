...
class SqlQueryModelDemo(QWidget):
    ...
    def setTableView(self):
        ...
        # 设置表头
        self.queryModel.setHeaderData(ID, Qt.Orientation.Horizontal, "编号")
        self.queryModel.setHeaderData(NAME, Qt.Orientation.Horizontal, "姓名")
        self.queryModel.setHeaderData(SUBJECT, Qt.Orientation.Horizontal, "科目")
        self.queryModel.setHeaderData(SEX, Qt.Orientation.Horizontal, "性别")
        self.queryModel.setHeaderData(AGE, Qt.Orientation.Horizontal, "年纪")
        self.queryModel.setHeaderData(SCORE, Qt.Orientation.Horizontal, "成绩")
        self.queryModel.setHeaderData(DESCRIBE, Qt.Orientation.Horizontal, "说明")
