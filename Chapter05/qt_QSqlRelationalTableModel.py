...
class SqlRelationalTableDemo(QMainWindow):
    ...
    def initModel(self):
        ...
        self.model.setHeaderData(3, Qt.Orientation.Horizontal, "科目")
        self.model.setHeaderData(4, Qt.Orientation.Horizontal, "成绩")
        self.model.select()
    ...
    def createWindow(self):
        ...
        self.tableView2.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
        ...
        self.tableView3.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Stretch)
