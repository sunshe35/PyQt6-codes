...
class QTableViewDemo(QMainWindow):
    ...
    def createTable(self):
        ...
        self.model.setHeaderData(0, Qt.Orientation.Horizontal, "编号")
        self.model.setHeaderData(1, Qt.Orientation.Horizontal, "姓名")
        self.model.setHeaderData(2, Qt.Orientation.Horizontal, "科目")
        self.model.setHeaderData(3, Qt.Orientation.Horizontal, "性别")
        self.model.setHeaderData(4, Qt.Orientation.Horizontal, "年纪")
        self.model.setHeaderData(5, Qt.Orientation.Horizontal, "成绩")
        self.model.setHeaderData(6, Qt.Orientation.Horizontal, "说明")
    ...
    def onUpdate(self):
        ...
        if self.sortType == '升序':
            self.model.setSort(self.comboBoxSort.currentIndex(), Qt.SortOrder.AscendingOrder)
        else:
            self.model.setSort(self.comboBoxSort.currentIndex(), Qt.SortOrder.DescendingOrder)
        self.model.select()
