...
class DataFrameModel(QtCore.QAbstractTableModel):
    ...
    _timestampFormat = Qt.DateFormat
    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        def convertValue(row, col, columnDtype):
            ...
            if columnDtype == object:
                ...
                value = QtCore.QDateTime.fromString(str(value), self.timestampFormat.ISODate)
                #print value
            # else:
        ...
        if value != index.data(role):
            ...
            if columnDtype == object:
                ...
                if isinstance(value, QtCore.QDateTime):
                    ...
                    value = value.toString(self.timestampFormat.ISODate)
                try:
