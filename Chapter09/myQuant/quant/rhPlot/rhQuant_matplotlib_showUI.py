...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 763, 572))
        ...
        self.pushButton_hide_output.clicked['bool'].connect(self.tableWidget.setVisible) # type: ignore
