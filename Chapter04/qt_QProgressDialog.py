...
class Main(QMainWindow):
    ...
    def __init__(self):
        ...
        self.slider_horizon = QSlider(Qt.Orientation.Horizontal)
    ...
    def show_modal(self):
        ...
        pd_modal.setWindowModality(Qt.WindowModality.WindowModal)
    ...
    def get_pd_auto(self):
        if not hasattr(self,'pd_auto'):
            ...
            self.pd_auto.setWindowModality(Qt.WindowModality.ApplicationModal)
    ...
    def show_custom(self):
        ...
        pd_custom.setWindowModality(Qt.WindowModality.WindowModal)
