...
class DragWidget(QWidget):
    ...
    def mousePressEvent(self, event: QtGui.QMouseEvent) -> None:
        ...
        action = drag.exec(Qt.DropAction.CopyAction | Qt.DropAction.MoveAction, Qt.DropAction.CopyAction)
        print(action)
