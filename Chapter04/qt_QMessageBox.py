...
class WinForm(QMainWindow):
    ...
    def showMessageBox1(self):
        reply = QMessageBox.information(self, "标题", "对话框消息正文",
                                        QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No | QMessageBox.StandardButton.Ok | QMessageBox.StandardButton.Apply,
    ...
    def showMessageBox2(self):
        ...
        msgBox.addButton(button1, QMessageBox.ButtonRole.ApplyRole)
    ...
    def showMessageBox3(self):
        ...
        msgBox.setText("点击响应按钮，会触发对应信号")
        msgBox.setStandardButtons(QMessageBox.StandardButton.Ok |QMessageBox.StandardButton.Save | QMessageBox.StandardButton.Discard | QMessageBox.StandardButton.Cancel| QMessageBox.StandardButton.No)
        msgBox.setDefaultButton(QMessageBox.StandardButton.Save)
        msgBox.setIcon(QMessageBox.Icon.Information)
        ...
        msgBox.addButton(button2, QMessageBox.ButtonRole.AcceptRole)
